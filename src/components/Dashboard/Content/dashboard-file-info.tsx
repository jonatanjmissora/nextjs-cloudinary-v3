...
export default function DashboardFileInfo({
	...
	return (
		<div className="absolute bottom-1 left-1 right-1 flex items-center justify-between text-black group-hover:opacity-100 opacity-0 bg-[var(--foreground)]/50 p-2">
